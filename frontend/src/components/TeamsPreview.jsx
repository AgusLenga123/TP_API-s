...
const teams = [
  { id: 1, name: 'Hawks', coach: 'John Smith', players: 12, color: '#e74c3c', record: '8-2' },
  { id: 2, name: 'Tigers', coach: 'Maria García', players: 11, color: '#f39c12', record: '7-3' },
  { id: 3, name: 'Lions', coach: 'Carlos López', players: 13, color: '#27ae60', record: '6-4' },
  { id: 4, name: 'Eagles', coach: 'Ana Martínez', players: 12, color: '#3498db', record: '5-5' },
  { id: 5, name: 'Wolves', coach: 'Roberto Díaz', players: 11, color: '#8e44ad', record: '4-6' },
  { id: 6, name: 'Bears', coach: 'Laura Sánchez', players: 12, color: '#2c3e50', record: '3-7' },
]
    ...
    <section className="teams section reveal" id="equipos">
      <div className="container">
        ...
        <div className="teams__grid">
          {teams.map((team) => (
            <div className="teams__card" key={team.id} id={`team-${team.id}`}>
              ...
              <div className="teams__card-body">
                ...
                <button className="btn btn-outline teams__btn" id={`btn-team-${team.id}`}>
                  Ver Equipo
                </button>
              </div>
            </div>
