    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()} style={{maxWidth: '400px', textAlign: 'center'}}>
        <div className="modal__body" style={{paddingTop: '32px'}}>
          ...
          <h2 className="modal__title" style={{marginBottom: '8px'}}>Eliminar Partido</h2>
          <p style={{color: 'var(--color-text-secondary)', fontSize: '0.875rem', lineHeight: '1.5'}}>
            ¿Seguro que deseas eliminar el partido <strong>{match.homeTeam} vs {match.awayTeam}</strong>?<br/>
        ...
        <div className="modal__footer" style={{justifyContent: 'center', background: 'transparent', borderTop: 'none', paddingBottom: '32px'}}>
          ...
          <button type="button" className="btn btn-primary" style={{background: '#ef4444', borderColor: '#ef4444'}} onClick={() => onConfirm(match.id)}>
            Eliminar
          </button>
        </div>
      </div>
